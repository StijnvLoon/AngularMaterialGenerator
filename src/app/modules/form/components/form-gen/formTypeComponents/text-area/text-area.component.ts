...
@Component({
  ...
  styleUrls: ['./text-area.component.scss', '../typeGeneral.scss']
})
export class TextAreaComponent extends FormTypeConcrete implements IFormType, OnInit, DoCheck, AfterViewInit {
  ...
  getHTMLCodeCallback() {
    return (formGroupName: string) => {
      ...
      const array: string[] = [
        ...
        '        <textarea type="text" matInput formControlName="' + controlName + '"' + this.getPlaceHolder() + '></textarea>'
      ]
